...
$(document).ready(function () {
    ...
    var iframeUrl = 'https://chat24h.net/client/'+ $("#chat24h").attr("data-user-id") +'?url='+ window.location.href +'&domain='+ window.location.hostname + '&device=desktop';
    if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
        iframeUrl = 'https://chat24h.net/client/'+ $("#chat24h").attr("data-user-id") +'?url='+ window.location.href +'&domain='+ window.location.hostname + '&device=mobile';
    }
    
    const userCode = $("#chat24h").attr("data-user-id");
    var html = '<style>#chat24h {width: 320px;height: 305px;border-bottom: 3px solid #0084ff;display: block;background: url("https://chat24h.net/chat-112.png") no-repeat;text-align: center;padding-top: 40px;position: fixed;bottom:0;right: 20px;z-index: 99999999999999; box-sizing: content-box;} #chat24h.highlight{bottom: 0px;}  #chat24h iframe{border:none;width:317px !important;padding-right: 2px !important;height:305px !important;margin:0px !important;position:relative !important;display: inline !important;} #chat24h:hover {cursor: pointer;} @media screen and (max-width: 320px){#chat24h{right: 0px !important;}} #panel_chat_vatgia{display:none !important;} .zopim{display:none !important;} .embed-responsive{padding-bottom:100% !important;} </style>';
        html += '<iframe id="iframeUhchat" frameborder="0" allowfullscreen src="'+ iframeUrl +'" width="304px" height="305px" style="padding:0px;"></iframe>';
